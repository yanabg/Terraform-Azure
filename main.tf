...
resource "azurerm_app_service_source_control" "wasc" {
  app_id   = azurerm_linux_web_app.alwa.id
  repo_url = "https://github.com/yanabg/taskboard.git"
  branch   = "main" # Specify the main branch name

  # Set to true to agree to deploy the app and its updates manually
  # when using an external Git repository (like GitHub)
